...
import { ArrowDownNarrowWide, Gamepad, MouseIcon } from "lucide-react";
    ...
    <>
      <div className="flex flex-col gap-2">
        <button
          ...
          <img src="/mouse-icon.svg" alt="Botão Plataforma Java" />
          Java
        </button>
        ...
        <button
          ...
          <img src="/gamepad-icon.svg" alt="Botão Plataforma Java" />
          Bedrock
        </button>
        ...
        <button
          ...
          <img src="/globe-icon.svg" alt="Botão Plataforma Java" />
          Crossplay
        </button>
      </div>
