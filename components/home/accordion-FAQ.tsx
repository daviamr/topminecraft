  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="O que é um servidor de Minecraft?">
        <AccordionTrigger className="font-semibold text-1xl">O que é um servidor de Minecraft?</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="O que é uma lista de servidores de Minecraft?">
        <AccordionTrigger className="font-semibold text-1xl">O que é uma lista de servidores de Minecraft?</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="Como entrar em um servidor de Minecraft?">
        <AccordionTrigger className="font-semibold text-1xl">Como entrar em um servidor de Minecraft?</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="Qual a diferença entre Minecraft Java e Bedrock?">
        <AccordionTrigger className="font-semibold text-1xl">Qual a diferença entre Minecraft Java e Bedrock?</AccordionTrigger>
        <AccordionContent>
