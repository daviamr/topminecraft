      ...
      <main>
        <div className="mt-8">
          <div className="flex flex-col gap-4 px-3">
            ...
            <div>
              <p>
                No <span className="font-bold">Top Minecraft Servers</span>,
                reunimos uma lista dos{" "}
                <span className="font-bold">
                  melhores servidores de Minecraft
                </span>{" "}
                disponíveis para você se divertir.
              </p>
              <p className="mt-2">
                Navegue pela nossa lista e descubra servidores incríveis, até
                encontrar aquele que se encaixa perfeitamente no seu estilo de
                jogo!
              </p>
            </div>
          </div>
